      ...
      <div>
        ...
        >
          <Typography paragraph style={{ fontSize: "20px" }}>
            ...
            meetings. Follow your favourite societies and never miss an update!
          </Typography>
        </Paper>
        <br />
        <br />
      ...
      <div>
        ...
        <Accordion style={{ backgroundColor: "#fffaf0" }}>
          <AccordionSummary expandIcon={<ExpandMoreIcon />}>
            <Typography style={{ fontSize: "25px" }}>Know yourself</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography paragraph style={{ fontSize: "20px" }}>
        ...
        <Accordion style={{ backgroundColor: "#fffaf0" }}>
          ...
          <AccordionDetails>
            <Typography paragraph style={{ fontSize: "20px" }}>
              ...
              establishing relationships will help you in the future. Since you
              are part of the same club, you will meet people with common
              interests, making it easier to understand them. It would provide
              you with a whole new opportunity to build some valuable
              connections. Most clubs or societies host alumni meetups and panel
              discussions by experts which might lead to potential employment
              opportunities.
            </Typography>
          </AccordionDetails>
        </Accordion>
        <Accordion style={{ backgroundColor: "#fffaf0" }}>
          ...
          <AccordionDetails>
            <Typography paragraph style={{ fontSize: "20px" }}>
              ...
              work ethics, time management, and communication, and enhance those
              you already possess. Leading an organization can make you a
              confident leader. Even if you are just a member, you can
        ...
        <Accordion style={{ backgroundColor: "#fffaf0" }}>
          ...
          <AccordionDetails>
            <Typography paragraph style={{ fontSize: "20px" }}>
              ...
              your interest and knowledge in extra-curricular activities thereby
              making you an all-rounder. You can present your leadership,
              communication, interpersonal and other skills and the experience
              you have acquired on your resume and during interviews. Be
              specific and include concrete examples such as organized an event,
              led the recruitment campaign and others.
            </Typography>
          </AccordionDetails>
        </Accordion>
      </div>
